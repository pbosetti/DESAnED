...
**IMPORTANT NOTE**: As a shortcut, a polynomial of third degree in the formula can be also written as: `y~poly(x, 3, raw=TRUE)`. If the model is **univariate**, prefer a raw polynomial. If the model is **multivariate**, prefer an orthogonal polynomial, obtained as `poly(x, n)`.
